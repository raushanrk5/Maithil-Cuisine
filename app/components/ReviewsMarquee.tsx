    ...
    <div className="overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
      ...
      >
        {doubled.map((review, i) => (
          <div
            key={i}
            className="w-72 sm:w-80 h-52 bg-white rounded-2xl p-6 shadow-sm border border-brand-cream-dark flex flex-col gap-3 shrink-0 overflow-hidden"
          >
            {/* Reviewer */}
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-brand-navy font-semibold text-sm truncate">{review.author_name}</p>
